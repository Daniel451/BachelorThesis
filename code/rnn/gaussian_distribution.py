...
class Gaussian:
    ...
    @staticmethod
    def get_noisy_normal_distribution(shape=(0, 10), mu=0.0, sigma=1.0):
        # creates a discrete gaussian vector with noise
        percentage = 0.15  # maximum percentage to be added or substracted from original distribution
        ...
        distri = distri + np.random.uniform(size=distri.shape, low=-0.0005, high=0.0005)
