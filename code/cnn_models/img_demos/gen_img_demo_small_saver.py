...
from cnn_lib.img_demo_net_api_rotated_small import net_api

# network model
from cnn_models.models.cnn_s11_ex17 import NetworkModel as net_cls
...
########################
net = net_cls("cnn_exp11_17")
net.load_network()

i = 0
for img_str in sys.argv[1:]:
    i += 1
    net_api(net, [mpimg.imread(img_str)], savefig=True, fname=img_str, i=i)
