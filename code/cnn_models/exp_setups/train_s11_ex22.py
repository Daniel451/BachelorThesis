...
from cnn_models.models.cnn_s11_ex22 import NetworkModel as net_cls
...
net = net_cls("cnn_exp11_22")
net.train(training_data, te_cnn_1, log_every_n_steps=500, amount_of_train_steps=int(2e5), dropout_rate=0.9)
